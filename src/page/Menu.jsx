  ...
  return (
    <div>
      ...
      <div className="d-flex justify-content-center gap-2 mt-5">
        <Button
          variant={kategori === "semua" ? "danger" : "outline-danger"}
          onClick={() => setKategori("semua")}
        >
          semua menu
        </Button>
        <Button
          variant={kategori === "makanan" ? "danger" : "outline-danger"}
        ...
        <Button
          variant={kategori === "minuman" ? "danger" : "outline-danger"}
        ...
        <Container>
          <Row xs={1} md={2} lg={3} className="g-4">
            <Col
              className="d-flex"
            >
              {(kategori === "semua" || kategori === "makanan") && (
                <Card
                  style={{
              ...
              {(kategori === "semua" || kategori === "makanan") && (
                ...
                <Card
                  ...
                  <div style={{ height: '230px' }}>
                    <Card.Img
                      variant="top"
                      src="https://i.pinimg.com/1200x/a9/25/06/a92506463ed07017c8aeabc4f1622130.jpg"
                      style={{
                        height: "230px",
                        objectFit: "cover"
                      }}
              ...
              {(kategori === "semua" || kategori === "makanan") && (
                ...
                <Card
                  ...
                  <div style={{ height: '230px' }}>
                    <Card.Img
                      variant="top"
                      src="https://i.pinimg.com/736x/d3/09/07/d3090715e5dfc2ee5beaf09beaa20e72.jpg"
                      style={{
                        height: "230px",
                        objectFit: "cover"
                      }}
            ...
            <Col
              className="d-flex"
            >
              {(kategori === "semua" || kategori === "minuman") && (
              ...
              {(kategori === "semua" || kategori === "minuman") && (
                ...
                <Card
                  ...
                  <div style={{ height: '230px' }}>
                    <Card.Img
                      variant="top"
                      src="https://i.pinimg.com/736x/81/68/b6/8168b6f71a64c4bd2dba556df2c053f0.jpg"
                      style={{
                        height: "230px",
                        objectFit: "cover"
                      }}
